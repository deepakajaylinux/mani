...
class AutoPilotConfigured extends AutoPilot {
    ...
    private function setSteps() {
        ...
        $this->steps =
            array(
                array ( "Logging" => array( "log" => array( "log-message" => "Lets begin Configuration of a Database Load Balancer on environment medium-bastion"),),),
...
//                    array("user-name" => "{$this->myUser}"),),),
                ...
                array ( "Logging" => array( "log" => array( "log-message" => "Configuring a Database Load Balancer on environment medium-bastion complete"),),),
