...
class AutoPilotConfigured extends AutoPilot {
    ...
    private function setSteps() {
        ...
        $this->steps =
            array(
                array ( "Logging" => array( "log" => array( "log-message" => "Lets begin Configuration of a Web Load Balancer on environment "),),),
...
//                    array("user-name" => "{$this->myUser}"),),),
                ...
                array ("Logging" => array( "log" => array(
                    "log-message" => "Configuring a Web Load Balancer on environment  complete"
                ),),),
